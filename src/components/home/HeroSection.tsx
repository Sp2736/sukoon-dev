  ...
  return (
    <section className="relative w-full h-[100svh] lg:h-screen min-h-[650px] lg:min-h-[850px] flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 px-6 md:px-16 lg:px-24 mt-0 lg:mt-12 w-full max-w-[850px]">
        ...
        <h1 className="font-heading font-bold text-white text-[42px] md:text-[54px] lg:text-[64px] leading-[1.1] lg:leading-[1.05] mb-4 lg:mb-6 drop-shadow-md">
          Build, Invest & Grow with Us
        </h1>

        {/* Sub-headline */}
        <p className="font-body text-white/90 text-[16px] md:text-[18px] lg:text-[20px] leading-[1.6] max-w-[700px] mb-8 lg:mb-12">
      ...
      <div className="absolute bottom-6 lg:bottom-10 left-6 md:left-16 lg:left-24 z-10 flex flex-col md:flex-row items-start md:items-center gap-4 lg:gap-12 md:gap-8">
        {/* Stat 1 */}
