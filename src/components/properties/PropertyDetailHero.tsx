...
export default function PropertyDetailHero({ 
  title, propertyType, area, location, price, bhk, images 
        ...
        <div className="w-full lg:w-[55%] flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-4 w-full h-[100px] md:h-[120px]">
            ...
            <div className="flex-1 flex gap-3 md:gap-4 h-full">
              <img src={images[1] || images[0]} alt="Thumbnail 1" className="w-1/3 h-full object-cover rounded-[16px]" />
              <img src={images[2] || images[0]} alt="Thumbnail 2" className="w-1/3 h-full object-cover rounded-[16px]" />
              <img src={images[3] || images[0]} alt="Thumbnail 3" className="w-1/3 h-full object-cover rounded-[16px]" />
            </div>
        ...
        <div className="w-full lg:w-[45%] bg-[#F4FAFD] border border-[#D9F2FF]/50 rounded-[24px] p-8 md:p-10 flex flex-col h-fit">
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="flex justify-between items-center py-4 border-b border-[#D9F2FF]">
              ...
              <span className="font-heading font-medium text-[18px] text-[#1F1F1F]">{propertyType}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-4 border-b border-[#D9F2FF]">
              ...
              <span className="font-heading font-medium text-[18px] text-[#1F1F1F]">{area}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-4 border-b border-[#D9F2FF]">
              ...
              <span className="font-heading font-medium text-[18px] text-[#1F1F1F]">{location}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-4 border-b border-[#D9F2FF]">
              ...
              <span className="font-heading font-medium text-[18px] text-[#1F1F1F]">{price}</span>
            </div>
            ...
            <div className="flex justify-between items-center py-4 border-b border-[#D9F2FF]">
              ...
              <span className="font-heading font-medium text-[18px] text-[#1F1F1F]">{bhk}</span>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="font-body text-[12px] font-medium text-[#1F1F1F]">Gymnasium</span>
              </div>
              {/* Icon 2 */}
              <div className="flex flex-col items-center gap-2">
                <div className="w-[50px] h-[50px] rounded-full border border-[#919191]/50 flex items-center justify-center text-[#919191]">
                ...
                <span className="font-body text-[12px] font-medium text-[#1F1F1F]">Swimming Pool</span>
              </div>
              {/* Icon 3 */}
              <div className="flex flex-col items-center gap-2">
                <div className="w-[50px] h-[50px] rounded-full border border-[#919191]/50 flex items-center justify-center text-[#919191]">
                ...
                <span className="font-body text-[12px] font-medium text-[#1F1F1F]">Living Room</span>
              </div>
              {/* Icon 4 */}
              <div className="flex flex-col items-center gap-2">
                <div className="w-[50px] h-[50px] rounded-full border border-[#919191]/50 flex items-center justify-center text-[#919191]">
                ...
                <span className="font-body text-[12px] font-medium text-[#1F1F1F]">Power Backup</span>
              </div>
              {/* Icon 5 */}
              <div className="flex flex-col items-center gap-2">
                <div className="w-[50px] h-[50px] rounded-full border border-[#919191]/50 flex items-center justify-center text-[#919191]">
                ...
                <span className="font-body text-[12px] font-medium text-[#1F1F1F]">Dining Area</span>
              </div>
            </div>
          </div>
