    ...
    <section className="bg-[#F5F5F5] w-full flex justify-center py-16 px-6 lg:py-[100px] lg:px-[90px] font-sans">
      <div className="w-full max-w-[1800px] flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-[10%]">
        ...
        <div className="w-full lg:w-[58%] flex flex-col">
          <h2 className="text-[#1E1E1E] font-bold text-4xl lg:text-[52px] leading-[1.2] lg:leading-[1.1] tracking-[-1px] mb-6 lg:mb-[40px]">
            Who We Are
          </h2>

          <p className="text-[#2A2A2A] font-medium text-lg lg:text-[22px] leading-relaxed lg:leading-[1.7] max-w-[760px] mb-6 lg:mb-[40px]">
          ...
          <p className="text-[#2A2A2A] text-opacity-90 font-medium text-lg lg:text-[22px] leading-relaxed lg:leading-[1.7] max-w-[760px]">
        ...
        {/* RIGHT COLUMN (Stats scaled down) */}
            ...
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[#1E1E1E] font-bold text-3xl lg:text-[48px] leading-none mb-2">
                    {stat.number}
                  </div>
                  <div className="text-[#9B9B9B] font-normal text-base lg:text-[20px] leading-snug">
                    {stat.label}
                  </div>
                </div>
              );
